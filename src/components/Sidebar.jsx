...
const Sidebar = ({ onLogout }) => {
  ...
  return (
    <div className="h-screen w-64 bg-gray-800 shadow-lg p-6 flex flex-col justify-between fixed left-0 top-0 z-50">
      <div>
        ...
        <ul className="space-y-4">
          ...
          <li>
            <button
              ...
              className={`w-full text-left px-4 py-2 ml-[-50px] rounded-lg cursor-pointer ${
                isActive("/upcoming")
                  ? "bg-teal-600 text-white"
                  : "bg-gray-700 hover:bg-gray-600 text-white"
              }`}
